          ...
          <div className="footer__body">
            <ul className="footer__content-items">
              <li className="footer__item">
                <span className="icon-apuntar"></span> Mis habilidades.
              </li>
              <li className="footer__item">
                <span className="icon-apuntar"></span> Mi formación educativa.
              </li>
              <li className="footer__item">
                <span className="icon-apuntar"></span> Mis Proyectos{" "}
                <button className="footer__boton"> Ver </button>
              </li>
              <li className="footer__item">
                <span className="icon-apuntar"></span> Mi Experiencia como
                desarrollor web.
              </li>
            </ul>
          </div>
        ...
        <div className="footer__content-Ind footer__content-categorias">
          ...
          <div className="footer__body">
            <ul className="footer__content-items">
              ...
              <li className="footer__item">
                <span className="icon-apuntar"></span>
                <strong>Maquetacion de páginas web</strong>
              </li>
              <li className="footer__item">
                <span className="icon-apuntar"></span>
                <strong>Page Responsive Web Design</strong>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer__content-Ind footer__content-contacto">
          ...
          <div className="footer__body">
            <ul className="footer__content-items">
              ...
              <li className="footer__item">
                <span className="footer__icon icon-phone"></span>+51 987 654 321
                / +51 912 345 678
              </li>
              <li className="footer__item">
      ...
      <div className="footer__cont-gen">
        <div className="footer__autor">
          <h6 className="footer__autor-text">
            2020 © Creador del sitio: Bach. Peralta Diaz Luis
          </h6>
        </div>
      </div>
    </footer>
